...
- **Global Version Synchronization**: All 29 modules, manifests, and static files (`LICENSE`, `README`, etc.) synchronized to version 1.6.6.
### Fixed
- Resolved publication collision on PowerShell Gallery by incrementing version to 1.6.6.
...
- Updated `tools/Validate-ForGallery.ps1` to support 1.6.6 metadata validation.
