...
<body>
    <div class="container">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>42%</td>
                        <td>68%</td>
                        <td><span style="color: #107c10;">â— Healthy</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>78%</td>
                        <td>85%</td>
                        <td><span style="color: #d83b01;">â— Warning</span></td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <footer>
            Generated by AnyStack.Reporting v1.5.0 | Report ID: RPT-$(Get-Date -Format 'yyyyMMddHHmmss')
        </footer>
    </div>
</body>
</html>
