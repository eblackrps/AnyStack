...
Describe "AnyStack.vSphere Suite" {
    ...
    Context "Get-AnyStackLicenseUsage" {
        ...
        It "Should be callable without throwing a syntax error" {
            { Get-AnyStackLicenseUsage -Server 'MockVC' -ErrorAction SilentlyContinue } | Should -Not -Throw
        }
    }
    Context "Get-AnyStackVcenterServices" {
        ...
        It "Should be callable without throwing a syntax error" {
            { Get-AnyStackVcenterServices -Server 'MockVC' -ErrorAction SilentlyContinue } | Should -Not -Throw
        }
    }
    Context "Invoke-AnyStackHealthCheck" {
        ...
        It "Should be callable without throwing a syntax error" {
            { Invoke-AnyStackHealthCheck -Server 'MockVC' -ErrorAction SilentlyContinue } | Should -Not -Throw
        }
    }
    Context "Write-AnyStackLog" {
        ...
        It "Should return a log entry without a connection" {
            ...
            $result.PSTypeName | Should -Be 'AnyStack.LogEntry'
        }
    }
}
